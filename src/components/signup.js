          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 flex content-center">
              <div className="text-justify self-center">
                <h4 className="font-bold text-4xl text-custom-blue mb-5">Welcome to Flambo</h4>

                <p className="mt-4">Get an exclusive experience with our
                  services by signing up and get access
                  to Flambo solutions on data engineering</p>
            ...
            <div className="p-4">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  <input type="password" id="confirm_password" name="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-m rounded-l block w-full p-2.5" placeholder="Enter password" />
                </div>
              ...
              <h6 className="mt-2">Don't have an account yet? <span className="underline text-custom-blue">SignIn</span></h6>
            </div>
          </div>
        </div>
      </section>
